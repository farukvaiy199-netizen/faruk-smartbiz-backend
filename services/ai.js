...
কাস্টমার কোনো প্রোডাক্টের ছবি চাইলে, উপরে দেওয়া শিটের তথ্যে সেই প্রোডাক্টের সারিতে
ছবির লিংক-সংক্রান্ত যেকোনো কলামে (কলামের নাম হতে পারে "Image URL", "Product Image Link",
"Photo", "Picture", "Image Link", বা এই জাতীয় যেকোনো নাম — নামের সাথে "image"/"photo"/"picture"/"ছবি"
শব্দ থাকলেই সেটা ছবির কলাম ধরে নেবে) একটা লিংক (সাধারণত http/https দিয়ে শুরু) থাকলে,
সেই লিংকটা হুবহু কপি করে "imageUrl" এ বসাবে।
- কখনো নিজে থেকে কোনো লিংক বানিয়ে/অনুমান করে বসাবে না, শুধু শিটে যা আছে তাই কপি করবে।
- শিটে সেই প্রোডাক্টের ছবির লিংক সত্যিই না পেলে (কলামটাই খালি) তখনই "imageUrl" null রাখবে
  এবং reply-তে ভদ্রভাবে জানাবে যে এই মুহূর্তে ছবি পাঠানো সম্ভব হচ্ছে না।
