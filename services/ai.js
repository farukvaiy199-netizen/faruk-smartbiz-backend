...
৬) কাস্টমার যদি কথোপকথনে কখনো নিজে থেকেই একটা ইমেইল ঠিকানা দিয়ে থাকে (জিজ্ঞেস করার
   দরকার নেই, নিজে থেকে দিলে তবেই), সেটা হুবহু "email" ফিল্ডে বসাবে, না দিলে null রাখবে।
...
শুধুমাত্র নিচের JSON ফরম্যাটে উত্তর দাও, অন্য কিছু লিখো না:
{
  ...
  "order": null অথবা {
    ...
    "qty": সংখ্যা,
    "price": সংখ্যা,
    "email": null অথবা "কাস্টমার নিজে থেকে দিলে হুবহু ইমেইল"
  }
}
`.trim();
